...
const initConfig = {
  ...
  model: [
    ...
    model_url_prefix + "lafei_4/lafei_4.model3.json",
    model_url_prefix + "小云/小云.model3.json",
    model_url_prefix + "BVBRuntime/bvb.model3.json",
    model_url_prefix + "ariu/ariu.model3.json",
    //model_url_prefix + "dbd_swimsuit/dbd_swimsuit.model3.json",
    model_url_prefix + "天使/天使.model3.json",
    model_url_prefix + "yuanjia/yuanjia.model3.json",
    model_url_prefix + "nitorudraw/nitorudraw.model3.json",
    model_url_prefix + "黑蜀黍/drawing1.model3.json",
  ],
  tips: true,
